            ...
            <ul class="buslist">
                <?php foreach ($documents as $document): ?>
                    <li>
                        ...
                        <span>Tujuan: <?php echo $document["Tujuan"]; ?></span><br>
                        <span>Berangkat: <?php echo $document["Berangkat"]; ?></span><br>
                        <span>Jarak: <?php echo $document["Jarak"]; ?></span><br>
                        <span>Jadwal: <?php echo $document["Jadwal"]; ?></span><br>
                        <span>Waktu: <?php echo $document["Waktu"]; ?></span><br>
